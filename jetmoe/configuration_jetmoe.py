...
class JetMoEConfig(PretrainedConfig):
    ...
    with the defaults will yield a configuration of the JetMoE-4B model.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            ...
            `input_ids` passed when calling [`JetMoEModel`].
        ...
        kv_channels (`int`, *optional*, defaults to 128):
            Number of channels for the key and value tensors.
        ffn_hidden_size (`int`, *optional*, defaults to 5632):
            Hidden size of the feed-forward layer.
        max_position_embeddings (`int`, *optional*, defaults to 4096):
            The maximum sequence length that this model might ever be used with. JetMoE's sliding window attention
            allows sequences of up to 4096*32 tokens.
        activation_function (`str`, *optional*, defaults to `"silu"`):
            The activation function for the MLP experts.
        glu (`bool`, *optional*, defaults to `True`):
            Whether to use Gated Linear Units (GLU) in the MLP experts.
        moe_num_experts (`int`, *optional*, defaults to 8):
            Number of experts in the mixture of experts.
        ...
        bias (`bool`, *optional*, defaults to `True`):
            Whether to use bias in the feed-forward and attention layers.
